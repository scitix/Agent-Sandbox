...
export interface paths {
    ...
    "/v1/platform/users/count": {
         ...
         * @description Returns a single deduplicated (team, user) count across every API key,
         *     platform-wide with no team isolation. Available to any authenticated
         *     caller — this is aggregate, desensitized data (a count), not key detail.
         */
        get: operations["PlatformUsersCount"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/admin/users/summary": {
         ...
         * @description Returns the deduplicated (team, user) user count platform-wide plus a
         *     per-team breakdown. Requires admin role — this backs the Key management
         *     detail view, distinct from the lightweight PlatformUsersCount endpoint.
         */
        get: operations["AdminUsersSummary"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/admin/notifications/config": {
        ...
        get: operations["AdminGetNotificationConfig"];
        /** Update daily-report and idle-alert notification config (admin) */
        put: operations["AdminUpdateNotificationConfig"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/v1/admin/notifications/daily-report/trigger": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["AdminTriggerDailyReport"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/admin/notifications/idle-alert/arm": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["AdminArmIdleAlert"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/admin/notifications/idle-alert/disarm": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["AdminDisarmIdleAlert"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/admin/notifications/history": {
        ...
        get: operations["AdminGetNotificationHistory"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        PlatformUsersCount: {
            /** @description Deduplicated (team, user) pair count across every API key, including expired keys. */
            totalUsers: number;
            /** Format: date-time */
            generatedAt: string;
        };
        AdminUsersSummaryTeam: {
            team: string;
            /** @description Deduplicated user count within this team. */
            users: number;
        };
        AdminUsersSummary: {
            totalUsers: number;
            byTeam: components["schemas"]["AdminUsersSummaryTeam"][];
            /** Format: date-time */
            generatedAt: string;
        };
        DailyReportConfig: {
            enabled: boolean;
            /** @description Hour of day (0-23) in Asia/Shanghai the daily report is sent. */
            sendHourCST: number;
        };
        IdleAlertConfig: {
            enabled: boolean;
            /** @description Cluster IDs monitored for the idle condition. Alert fires only when ALL of them are simultaneously idle. */
            watchedClusters: string[];
            /** @description Minutes of zero sandbox-create activity (any result) required to consider a cluster idle. */
            idleThresholdMinutes: number;
            /** @description Whether idle detection is currently active. Auto-disarmed after firing once. */
            armed: boolean;
            /** Format: date-time */
            armedAt?: string | null;
        };
        NotificationConfig: {
            dailyReport: components["schemas"]["DailyReportConfig"];
            idleAlert: components["schemas"]["IdleAlertConfig"];
        };
        NotificationHistoryEntry: {
            /** Format: date-time */
            time: string;
            /** @enum {string} */
            type: "dailyReport" | "idleAlert";
            /** @enum {string} */
            result: "success" | "failure";
            /** @description Failure reason, or a short human-readable summary on success. */
            detail?: string;
        };
        NotificationHistory: {
            entries: components["schemas"]["NotificationHistoryEntry"][];
        };
        DailyReportTriggerResult: {
            /** @enum {string} */
            result: "success" | "failure";
            detail?: string;
        };
    ...
    PlatformUsersCount: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PlatformUsersCount"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    AdminUsersSummary: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminUsersSummary"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    AdminTriggerDailyReport: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DailyReportTriggerResult"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    AdminArmIdleAlert: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["IdleAlertConfig"];
                };
            };
            /** @description Unauthorized */
            401: {
