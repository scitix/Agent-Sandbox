...
import { ObservabilitySection, SessionSection } from "@/components/managed-agents/detail-sections"
...
/**
 * Session tab — thread persistence, Brain deployment and telemetry export.
 * Observability is a handful of fields, so it shares this tab rather than
  ...
  return (
    <div className="min-h-0 flex-1 overflow-y-auto px-6 py-4">
      <div className="flex flex-col gap-6">
        ...
        <ObservabilitySection agent={agent} />
      </div>
    </div>
  )
}
