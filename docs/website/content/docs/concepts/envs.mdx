...
| `overrides.gateway` | the **switch** that gives the env's Pods an egress sidecar — see [egress and secrets](/docs/concepts/secrets) |
...
- [Egress and secrets](/docs/concepts/secrets) — the env's gateway switch
