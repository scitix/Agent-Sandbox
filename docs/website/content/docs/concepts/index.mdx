...
```mermaid
flowchart TB
  T["SandboxTemplate<br/>the Pod shape and runtime<br/><i>platform admin</i>"]
  E["SandboxEnv<br/>the name you create sandboxes with<br/><i>you</i>"]
  P["SandboxPool<br/>pre-warmed Pods of one resource shape<br/><i>you</i>"]
  S(["sandbox<br/>your code, running"])
