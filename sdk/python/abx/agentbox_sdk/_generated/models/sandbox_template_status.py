...
class SandboxTemplateStatus:
    """ 
        Attributes:
            ready (bool | Unset): True when the template has been validated and is ready for use.
            message (str | Unset): Human-readable status message, populated when ready is false.
     """
