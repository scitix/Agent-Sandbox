...
T = TypeVar("T", bound="SandboxTemplateSummary")



@_attrs_define
class SandboxTemplateSummary:
    """ Lightweight summary returned by the List endpoint — omits spec, specYaml, labels, annotations, status, and full docs
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        runtime_names: list[str] | Unset = UNSET
        if not isinstance(self.runtime_names, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        runtime_names = cast(list[str], d.pop("runtimeNames", UNSET))
        ...
        sandbox_template_summary.additional_properties = d
        return sandbox_template_summary
