...
T = TypeVar("T", bound="UpdateEnvAutoscalingGroupRequest")
...
class UpdateEnvAutoscalingGroupRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_env_autoscaling_group_request = cls(
            enabled=enabled,
        ...
        update_env_autoscaling_group_request.additional_properties = d
        return update_env_autoscaling_group_request
