...
T = TypeVar("T", bound="SandboxPoolSummary")



@_attrs_define
class SandboxPoolSummary:
    """ Lightweight shape returned by the pool List endpoint: the full SandboxPool minus the heavy specYaml (full pod-
    template YAML) and overrides, neither of which list consumers read. Fetch GET /envs/{name}/sandboxpools/{poolName}
    for the full body (incl. specYaml for the diff view).
        ...
        Attributes:
            ...
            scaling_group (str | Unset): Scaling group this pool belongs to. Members in the same group share an autoscaling
                policy. Empty when excluded from autoscaling.
            ...
            owning_env (str | Unset): Name of the SandboxEnv that owns this pool (resolved from OwnerReferences).
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sandbox_pool_summary.additional_properties = d
        return sandbox_pool_summary
