...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EnvdSpec) DeepCopyInto(out *EnvdSpec) {
	*out = *in
	if in.Verbose != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnvdSpec.
func (in *EnvdSpec) DeepCopy() *EnvdSpec {
	if in == nil {
		return nil
	}
	out := new(EnvdSpec)
